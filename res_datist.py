...
def plot_obs(df, title='', filename='myfig.png'):
    ...
    ax.set_title(title)
    fig.savefig(f'./{filename}', dpi=300, bbox_inches='tight')
...
plot_obs(df1, filename=f'{stationname}地电阻率东西向.png')
plot_obs(df2, filename=f'{stationname}地电阻率东西向残差.png')
plot_obs(df3, filename=f'{stationname}地电阻率东西向相对变化幅度.png')
...
df2 = df[['residual', 'trend']]
df3 = df[['relative_range', 'annual_1', 'annual_2', 'std_1', 'std_2']]
plot_obs(df1, filename=f'{stationname}地电阻率南北向.png')
plot_obs(df2, filename=f'{stationname}地电阻率南北向残差.png')
plot_obs(df3, filename=f'{stationname}地电阻率南北向相对变化幅度.png')
